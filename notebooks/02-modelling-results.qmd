...
group_effects <- 
  ...
  mutate(
    lm = list(
      lm(score ~ aphantasia, data = data)
    ),
    lm_ranked = list(
      lm(rank(score) ~ aphantasia, data = data)
    ),
    ranked_means = list(
      prepare_means(lm_ranked, questionnaire)
    ),
    table = list(
      generate_model_summary(lm, lm_ranked, questionnaire)
    )
  )
...
corr_whole |> summary() |> plot() + 
  labs(title = "Correlation matrix, whole group")

corr_aph |> summary() |> plot() +
  labs(title = "Correlation matrix, aphantasia group only")

corr_control |> summary() |> plot() +
  labs(title = "Correlation matrix, control group only")
```
...
df_questionnaires |> plot_correlations("VVIQ", "Implicit effect")
df_questionnaires |> plot_correlations("OSIQ_Object", "Implicit effect")
df_questionnaires |> plot_correlations("SUIS", "Implicit effect")
df_questionnaires |> plot_correlations("SUIS", "Explicit effect")

# Ranked versions
df_q_ranked |> plot_correlations("VVIQ", "Implicit effect")
df_q_ranked |> plot_correlations("OSIQ_Object", "Implicit effect")
df_q_ranked |> plot_correlations("SUIS", "Implicit effect")
df_q_ranked |> plot_correlations("SUIS", "Explicit effect")
```
